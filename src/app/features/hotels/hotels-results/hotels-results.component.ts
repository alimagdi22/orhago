...
import { GetHotelModule, HotelRoomsService, HotelResultsService } from 'rp-hotels-ui';
...
export class HotelsResultsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(){
    ...
    this.subscriptions.add(
      this.sharedService.toggleHotelSearchNotifier.subscribe(() => {
